        ...
        <>
            <Container className="p-5 m-0" style={{height:'100vh', width:'25%', backgroundColor:'#161616', position:'fixed'}}>
                <Stack direction="vertical" >
                    ...
                    return(
                    <Stack key={index} direction="horizontal" className="mb-3 btn ps-0" onClick={() => navigate("/creator")}>
                        <div className="d-flex flex-column justify-content-center me-3">
                            <Image src={channel?.photo === "" ? Foto : channel?.photo} style={{width:"60px", height:"60px", borderRadius:"10px", objectFit:"cover"}}/>
                        </div>
